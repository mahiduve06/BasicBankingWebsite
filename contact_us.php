...
<body  style="background-image:url('https://image.shutterstock.com/image-illustration/website-internet-contact-us-icons-260nw-761250151.jpg'); padding-top:8%;">
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:80%; background-color:rgba(0,0,0,.65); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:orange;">Contact Us</h1>
            </div>

            <div class="container"
                style=" backdrop-filter: blur(7px);  border-radius:5px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%;">
