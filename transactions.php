...
<body style="background-image:url('https://t1.pixers.pics/img-1fb6f67c/posters-paper-crumpled-background.jpg?H4sIAAAAAAAAA3VOW27EIAy8DpGStQs4CTnA_u4RIgTOlm4eCGi76ulLtOpnZY08tjyegc8924XB8V44wRa8XxmWsNYpT4lz-GFBJFtsprpdBWJlxxcnl44oOlLtiR6HE830batws-kh3kuJeQLI6hLDs36rzWVwWwaJbwPgAGR6NSqj0PeDn-PavQ5LcI-uxyfhJe73Fs9q_rJoxFafGUoKm6ihjmpXxEe8N_CP5YtDVcH1BlqDVCANGDpX8_WmtVTSGJqNGWU_-sUult3IA6El61mzdSS1okt1-QWTY44qMQEAAA==');">
...
?>
            <table class="table table-dark" style="margin-top: 30px; color:#FCB15C">
                <thead>
                    <tr>
...
echo "<tbody>";
        ...
        if(!(empty($row['sender']) && empty($row['receiver']) && empty($row['amount'])))
            ...
            <tr>
              ...
              <td>'.$row['receiver'].'</td>
              <td>'.$row['amount'].'</td>
              <td>'; ?> <?php if($row['status'] == "succeed"){echo '<b><p style="color:#71E432;">Success</p></b>';}else{echo '<b><p style="color:red;">Failed</p></b>';} ?>
              <?php echo '</td>
              </tr>';}
    }
