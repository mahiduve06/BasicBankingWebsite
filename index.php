...
<head>
    ...
    <title>Welcome to The Rajathan Bank</title>
    ...
    left: 0;
    z-index: 20;
    background: rgb(255,120,255) center no-repeat;
    text-align:center;
        }
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:candara; font-size:24px; box-shadow: 0px 0px 10px 0px black;">
        <div class="container-fluid">
            <a href="index.php"><img src="https://cdn.logojoy.com/wp-content/uploads/2018/05/30160348/1528.png" alt=""
    ...
    <div class="container-large"
        style="color:#EEDBD1; height:500px; width: 100%; padding:8% 2% 2% 2%; background-image:url('https://cutewallpaper.org/21/wallpapers-for-website/Best-Background-Wallpapers-71+-images-.jpg');">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> National 
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="https://c.neh.tw/thumb/f/720/5763848611037184.jpg" class="zoomin" alt="">
            </div>
        </div>
    </div>
    <img src="https://media.istockphoto.com/vectors/abstract-diagonal-black-background-with-golden-lines-luxury-style-vector-id1224381750?k=20&m=1224381750&s=612x612&w=0&h=S3z_zNoZop-Dq0yPlxpCXGz7eXYIzMDMnlQhEhG5KPY=" alt="" style="width:100%; position:absolute; z-index:-1">
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#F87E45; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            ...
                            <h6>Here, you can see the list of customers in our bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
